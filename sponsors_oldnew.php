...
<section id="sponsors" class="section hide">
	<div class="container">
	<!-- Gold Keppel -->
...
<!-- <h1 class="section-header">Be Our Sponsor</h1> -->
	<div class="row">
		<h2 class="section-header header-bar header-sponsors">Why Sponsor?</h2>
	</div>
...
<?		}																?>
	...
	<div class="row mar-top30">
		<h2 class="section-header header-bar header-sponsors">Sponsorship Packages for 2016</h2>
	</div>
