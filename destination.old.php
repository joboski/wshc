...
<? 		}																	?>
		...
		<div class="row">
			<div class="mar-bot20"><h3 class="category">Official Hotel</h3></div>
			<div class="col-md-4 col-md-offset-4">
				<p class="align-center">Pan Pacific Hotel</p>
				<a href="https://www.panpacific.com"><img src="images/hotels/panpacific.jpg" alt="hotel image" class="img-stretch change_pic"
		...
		<!-- </div> -->
		<div class="row">
			<div class="mar-top20"><h3 class="category lime_green">Hotels Partners within the vicinity</h3></div>
<?			foreach( $travel['hotel']['other'] as $hotel ){					?>
			<div class="col-md-4 col-sm-6 col-xs-12 align-center">
				<p class="mar-top30 align-center"><?= $hotel[0] ?></p>
				<a href="<?= $hotel[1] ?>"><img src="images/<?= $hotel[2] ?>" alt="hotel" class="img_max_width change_pic"
	...
	<div class="container">
		...
		<div class="mar-bot60">
			...
			<div class="row mar-bot50">
				...
				<div class="col-md-3 col-md-pull-9 mar-bot30">
...
<div class="section parallax-new">
			    ...
			    <div class="panel panel-default">
			        <div class="panel-heading">
			            <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" style="text-decoration:none;"><h4 class="panel-title">
			               Foreign Visitors Visa Requirement
			            </h4></a>
			        </div>
