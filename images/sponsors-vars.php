<?php
	...
	$sponsors_para = [
		...
		'By sponsoring the WSH Conference, you not only showcase your organisation’s commitment in the area of WSH, but also exemplify leadership in getting other organisations more involved in raising WSH standards.',
